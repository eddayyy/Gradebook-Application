...
- **Description:** Users can delete a student from the table by clicking anywhere on the student's row and pressing the "Delete Student" button.
...
- **Description:** A user can modify any student's grades on the table by double clicking the cell. Once the grade is changed a recalculation of the students final grade will be triggered. 
...
- **Description:** Users can search for a student through their Student ID (SID) to view their current scores for all assignments. This will clear the table, displaying only the searched-for student. The user can revert the table and clear the search by clicking the "X" button.  
